...
%=====================================================================
function testResult = TrTestLarsonMiller( lmModel, creepData )
  ...
  testResult.trPredicted = PredictLarsonMiller( lmModel, ConvTemp(testResult.T,'c','k'), testResult.stress );
