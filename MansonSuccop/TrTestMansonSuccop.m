...
%=====================================================================
function testResult = TrTestMansonSuccop( msModel, creepData )
  ...
  testResult.trPredicted = PredictMansonSuccop( msModel, ConvTemp(testResult.T,'c','k'), testResult.stress );
