...
function exportToExcel() {
  ...
  for (var i = 0; i < osdData.masterCurve.coefficients.length; i++) {
  ...
  var nTr = osdData.stressTest.tr.length;
  var nT = osdData.stressTest.T.length;
  ...
  for (var k = 0; k < osdData.trTest.T.length; k++) {
