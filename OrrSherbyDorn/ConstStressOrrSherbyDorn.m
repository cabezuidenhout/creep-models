...
%=====================================================================
function constT = ConstStressOrrSherbyDorn( osdModel, stress, minT = 400, maxT = 750, n=200)
  ...
  for i=1:length(stress)
    constT.tr(:,i) = PredictOrrSherbyDorn( osdModel, ConvTemp(constT.T,'c','k'), stress(i));
  end
